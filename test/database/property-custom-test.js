// describe("ODatabaseSession API - Property - Custom", function() {
//   before(function() {
//     return CREATE_TEST_DB(this, "testdb_dbapi_property_custom")
//       .bind(this)
//       .then(() => {
//         return TEST_CLIENT.session({ name: "testdb_dbapi_property_custom" });
//       })
//       .then(db => {
//         this.db = db;
//       })
...
//       return this.prop.custom.set("foo", "bar").then(function(response) {
...
//         .set("json", JSON.stringify(jsonInput))
...
//       return this.prop.custom.unset("json").then(function(response) {
//         response.should.eql({ foo: "bar" });
//       });
//     });
//   });
