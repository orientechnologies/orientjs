...
Operation.prototype.consume = function (buffer, offset) {
  ...
  if (this.status === Operation.PENDING) {
    ...
    if (code === 3) {
      ...
      let pushType = buffer.readUInt8(offset + 1);
      ...
      if (pushType === 81) {
        ...
        offset += 2; // ignore the next integer
        obj = {};
...
// Operation.prototype.parseLink = function (buffer, offset, context, fieldName, reader) {
//
//   let element = {};
//   context[fieldName] = element;
//   this.stack.push(element);
//   this.readShort('cluster');
//   this.readLong('position');
//   this.readOps.push((data) => {
//
