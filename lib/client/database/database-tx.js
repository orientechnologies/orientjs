...
const applyCreated = (response, creates, transformer) => {
...
const applyUpdated = (response, updates, transformer) => {
    ...
    return this._flush().then(() => {
      ...
      return this._finalPrepare()
        ...
        .spread(function(creates, updates, deletes, response) {
          ...
          return {
            created: applyCreated(response, creates, item => item),
            updated: applyUpdated(response, updates, item => item),
            deleted: deletes,
