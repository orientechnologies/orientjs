...
class SessionQuery extends Query {
  ...
  exec(params) {
    ...
    return new Promise((resolve, reject) => {
      ...
      // TODO change command/query/batch

      observable = this.db.batch(statement, opts);
      // if (this.isIdempotent()) {
      //   observable = this.db.query(statement, opts);
      // } else {
      //   observable = this.db.command(statement, opts);
      // }
