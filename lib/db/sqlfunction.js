...
SqlFunction.prototype.shortestPath =
  function (sourceVertex,destinationVertex,direction,edgeClassName,additionalParams) {
var args = [];
...
SqlFunction.prototype.distance = function (xField,yField,xValue,yValue) {
var args = [];
 args.push(xField,yField,xValue,yValue);
