...
const VERTEX_CLASS_NAME = 'V';
const EDGE_CLASS_NAME = 'E';
const PERSISTENT_CLASS_NAME = 'ORIDs';
const FIELD_IN = 'in';
const FIELD_OUT = 'out';
...
Graph.prototype.checkForGraphSchema = function () {
  ...
  var checkVertexClass = function() {
    return checkClassWithShortName('vertexClass', VERTEX_CLASS_NAME, 'V', 'LINKSET')
  ...
  .then(function(results) {
    return checkClassWithShortName('edgeClass', EDGE_CLASS_NAME, 'E', 'LINK');
  })
  .then(this.reload);
}
