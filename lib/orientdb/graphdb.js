...
function getEdgesByDirection(self, sourceVertex, direction, callback) {
    var edgesRids = sourceVertex[direction];
    var final_size = edgesRids.length;
    var edges = [];
...
GraphDb.prototype.getOutEdges = function(sourceVertex, callback) {
    getEdgesByDirection(this, sourceVertex, FIELD_OUT, callback);
};

GraphDb.prototype.getInEdges = function(sourceVertex, callback) {
    getEdgesByDirection(this, sourceVertex, FIELD_IN, callback);
};
