...
var util = require("util"),
    ...
    command = function() {
        ...
        // TODO in the spec this command should return a byte (Why is this necessary btw? Anyway it' missing from response!)
    };
...
command.operation = OperationTypes.DB_DELETE;
