...
function readPayloadResultSetPreFetchedRecordInitialShort(buf, offset) {
    ...
    if (parser.isNullOrUndefined(this.result.content.subcontents)) {
        this.result.content.subcontents = [];
    }

    this.result.content.subcontents.push({});
...
function readPayloadResultSetPreFetchedRecordRecordType(buf, offset) {
    ...
    var subcontent = this.result.content.subcontents[this.result.content.subcontents.length - 1];
