...
Db.prototype.cascadeSave = function(masterDocument, callback) {
    ...
    function subElementByPath(document, pathParts, maxDepth) {
        if (maxDepth === null || typeof maxDepth === "undefined") {
    ...
    function rebuildMasterDocumentWithSavedDocuments(masterDocument, orderedPaths, orderedSavedDocs) {
    ...
    saveDocumentsByPaths(masterDocument, orderedPaths.slice(0), orderedSavedDocs, function(err) {
        ...
        rebuildMasterDocumentWithSavedDocuments(masterDocument, orderedPaths, orderedSavedDocs);
