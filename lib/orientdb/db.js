...
Db.prototype.close = function() {
	...
	return new Promise(function(resolve, reject) {
		self.server.send(OperationTypes.REQUEST_DB_CLOSE).then(
			function(results) {
				resolve(results);
			},
			function(error) {
...
Db.prototype.configGet = function(key) {
	var self	= this;
	...
	return new Promise(function(resolve, reject) {
		...
		self.server.send(OperationTypes.REQUEST_CONFIG_GET, data).then(
			function(results) {
				resolve(results);
			},
			function(error) {
...
Db.prototype.configList = function() {
	var self	= this;

	return new Promise(function(resolve, reject) {
		self.server.send(OperationTypes.REQUEST_CONFIG_LIST).then(
			function(results) {
				resolve(results);
			},
			function(error) {
...
Db.prototype.configSet = function(key, value) {
	var self	= this;
	...
	return new Promise(function(resolve, reject) {
		...
		self.server.send(OperationTypes.REQUEST_CONFIG_SET, data).then(
			function(results) {
				resolve(results);
			},
			function(error) {
...
Db.prototype.drop = Db.prototype.delete = function(database) {
	var self	= this;
	...
	return new Promise(function(resolve, reject) {
		...
		self.server.send(OperationTypes.REQUEST_DB_DROP, database).then(
			function(results){
				resolve(results);
			},
			function(error) {
...
Db.prototype.exist = function(name, type) {
	var self	= this;
	...
	return new Promise(function(resolve, reject) {
		...
		self.server.send(OperationTypes.REQUEST_DB_EXIST, data).then(
			function(results){
				resolve(results);
			},
			function(error) {
...
Db.prototype.list = function() {
	...
	return new Promise(function(resolve, reject) {
		self.server.send(OperationTypes.REQUEST_DB_LIST).then(
			function(results){
				results			= results || {};
				resolve(results);
			},
...
Db.prototype.shutdown = function() {
	...
	return new Promise(function(resolve, reject) {
		var data	= {
			...
			password:self.server.userPassword
		};

		self.server.send(OperationTypes.REQUEST_SHUTDOWN, data).then(
			function(results){
				resolve(results);
			},
			function(error) {
