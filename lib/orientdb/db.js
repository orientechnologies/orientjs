...
Db.prototype.copy = function(database, callback) {
	...
	var databaseUser		= database.username || '';
	var databasePass		= database.password || '';
	var remoteServerName	= database.remoteServerName || '';
	var remoteServerEngine	= database.remoteServerEngine || '';
