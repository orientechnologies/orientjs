...
Db.prototype.getDataSegmentById = function(dataSegmentId) {
    ...
    for (var idx = 0, length = this.configuration.dataSegments.length; idx < length; idx++) {
        if (this.configuration.dataSegments[idx].dataId === dataSegmentId) {
            return this.configuration.dataSegments[idx];
        }
    }
