...
Db.prototype.copy = function(database) {
	...
	return new Promise(function(resolve, reject) {
		...
		self.server.send(OperationTypes.REQUEST_DB_COPY, data)
			.then(function(results){
				resolve(results);
			})
			.error(function(error) {
...
Db.prototype.create = function(database) {
	...
	return new Promise(function(resolve, reject) {
		...
		self.server.send(OperationTypes.REQUEST_DB_CREATE, obj)
			.then(function(results){
				resolve(results);
			})
			.error(function(error) {
	...
	return new Promise(function(resolve, reject) {
		self.server.init()
			.then(function(results){
				...
				self.server.send(OperationTypes.REQUEST_DB_OPEN, data)
					.then(function(results){
						self.serverProtocolVersion	= OperationTypes.SERVER_PROTOCOL_VERSION;
...
Db.prototype.size = function() {
	...
	return new Promise(function(resolve, reject) {
		self.server.send(OperationTypes.REQUEST_DB_SIZE)
			.then(function(results){
				resolve(results);
			})
			.error(function(error) {
...
Db.prototype.countRecords = function() {
	...
	return new Promise(function(resolve, reject) {
		self.server.send(OperationTypes.REQUEST_DB_COUNTRECORDS)
			.then(function(results){
				resolve(results);
			})
			.error(function(error) {
...
Db.prototype.reload = function() {
	...
	return new Promise(function(resolve, reject) {
		self.server.send(OperationTypes.REQUEST_DB_RELOAD)
			.then(function(results){
				self.clusters	= results.clusters;
				resolve(results);
			})
...
Db.prototype.command = Db.prototype.query = function(command, options) {
	...
	return new Promise(function(resolve, reject) {
		...
		self.server.send(OperationTypes.REQUEST_COMMAND, data)
			.then(function(results) {
				return processResults(results, resolve, reject);
			})
			.error(function(error) {
				return reject(error);
			});
...
Db.prototype.recordLoad = function(record) {
	...
	function onLoadRecord(record) {
		return new Promise(function(resolve, reject) {
			...
			self.server.send(OperationTypes.REQUEST_RECORD_LOAD, data)
				.then(function(results) {
					if (!results) {
					...
					var item = processResult(results, results.subcontents, resolve, reject);
...
Db.prototype.recordCreate = function(record) {
	...
	return new Promise(function(resolve, reject) {
		...
		self.server.send(OperationTypes.REQUEST_RECORD_CREATE, data)
			.then(function(results) {
...
Db.prototype.recordUpdate = function(record) {
	...
	return new Promise(function(resolve, reject) {
		...
		function onUpdate(error, results) {
			...
			self.server.send(OperationTypes.REQUEST_RECORD_UPDATE, data)
				.then(function(results) {
...
Db.prototype.recordDelete = function(record) {
	...
	return new Promise(function(resolve, reject) {
		...
		self.server.send(OperationTypes.REQUEST_RECORD_DELETE, data)
			.then(function(results) {
				resolve(results);
			})
			.error(function(error) {
...
Db.prototype.recordMetadata = function(record) {
	...
	return new Promise(function(resolve, reject) {
		...
		self.server.send(OperationTypes.REQUEST_RECORD_METADATA, data)
			.then(function(results) {
				var record	= {};
				record['@rid']		= rid.recordId;
				record['@type']		= 'd';
...
function makePositionFunc(operation, record) {
	...
	return new Promise(function(resolve, reject) {
		...
		self.server.send(operation, data)
			.then(function(results) {
				resolve(results);
			})
			.error(function(error) {
...
Db.prototype.recordCleanOut = function(record) {
	...
	return new Promise(function(resolve, reject) {
		...
		self.server.send(OperationTypes.REQUEST_RECORD_CLEAN_OUT, data)
			.then(function(results) {
				resolve(results);
			})
			.error(function(error) {
...
Db.prototype.dataClusterAdd	= function(cluster) {
	...
	return new Promise(function(resolve, reject) {
		...
		self.server.send(OperationTypes.REQUEST_DATACLUSTER_ADD, data)
			.then(function(results) {
				resolve(results);
			})
			.error(function(error) {
...
Db.prototype.dataClusterDrop = function(clusterId) {
	...
	return new Promise(function(resolve, reject) {
		...
		self.server.send(OperationTypes.REQUEST_DATACLUSTER_DROP, data)
			.then(function(results) {
				resolve(results);
			})
			.error(function(error) {
...
Db.prototype.dataClusterCount = function(clusterIds, loadTombstones) {
	...
	return new Promise(function(resolve, reject) {
		...
		self.server.send(OperationTypes.REQUEST_DATACLUSTER_COUNT, data)
			.then(function(results) {
				resolve(results);
			})
			.error(function(error) {
...
Db.prototype.dataClusterDataRange = function(clusterId) {
	...
	return new Promise(function(resolve, reject) {
		...
		self.server.send(OperationTypes.REQUEST_DATACLUSTER_DATARANGE, data)
			.then(function(results) {
				resolve(results);
			})
			.error(function(error) {
...
Db.prototype.dataSegmentAdd = function(segmentName, segmentLocation) {
	...
	return new Promise(function(resolve, reject) {
		...
		self.server.send(OperationTypes.REQUEST_DATASEGMENT_ADD, data)
			.then(function(results) {
				self.reload()
					.then(function(results) {
						resolve(results);
...
Db.prototype.dataSegmentDrop = function(segmentName) {
	...
	return new Promise(function(resolve, reject) {
		self.server.send(OperationTypes.REQUEST_DATASEGMENT_DROP, segmentName)
			.then(function(results) {
				self.reload()
					.then(function(results) {
						resolve(results);
...
/* Utils */
function processResults(results, resolve, reject) {
    var records = [];
    ...
    switch (results.status) {
        ...
        case 114: // 'r'
            for (var idx = 0, length = content.length; idx < length; idx++) {
				var item	= processResult(content[idx], results.subcontents, resolve, reject);
        ...
        default:
            return reject(new Error('OrientDB: Unexpected or unimplemented result status: ' + results.status));
    }

    return resolve(records);
}

function processResult(content, subcontents, resolve, reject) {
    var record;
    ...
    switch (content.type) {
        ...
        case 'd':
            ...
            if(subcontents) {
                ...
                for (var idx = 0, length = subcontents.length; idx < length; idx++) {
                    var item = processResult(subcontents[idx], null, resolve, reject);
        ...
        default:
            reject(new Error('OrientDB: Invalid or not supported record type: ' + content.type));
			return;
    }
...
Db.prototype.classCreate = function(classData) {
	...
	return new Promise(function(resolve, reject) {
		...
		if (parser.isNullOrUndefined(cluster)) {
			...
			self.dataClusterAdd(clusterOptions)
				.then(function(results) {
					onClassCreate(className, results.clusterId)
						.then(function(results) {
							resolve(results);
						})
						.error(function(error) {
			...
			onClassCreate(className, cluster.id)
				.then(function(results) {
					resolve(results);
				})
				.error(function(error) {
...
Db.prototype.classDrop = function(classData) {
	...
	return new Promise(function(resolve, reject) {
		...
		self.query('DROP CLASS ' + className)
			.then(function(results) {
				self.reload()
					.then(function(results) {
						resolve(1);
...
Db.prototype.countRecordsInCluster = function(clusterName) {
	...
	return new Promise(function(resolve, reject) {
		self.server.send(OperationTypes.COUNT, clusterName)
			.then(function(results) {
				var results		= results || {};
