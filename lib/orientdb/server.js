...
Server.prototype.send = function(operation, options) {
	...
	return new Promise(function(resolve, reject) {
		self.manager.writeRequest(self.sessionId, operation, options)
			.then(function(results){
...
Server.prototype.close = function() {
	...
	return new Promise(function(resolve, reject) {
		self.send(OperationTypes.REQUEST_DB_CLOSE)
			.then(function(results) {
				resolve(results);
			})
			.error(function(error) {
...
Server.prototype.drop = Server.prototype.delete = function(database) {
	...
	return new Promise(function(resolve, reject) {
		...
		self.send(OperationTypes.REQUEST_DB_DROP, database)
			.then(function(results){
				resolve(results);
			})
			.error(function(error) {
...
Server.prototype.exist = function(name, type) {
	...
	return new Promise(function(resolve, reject) {
		...
		self.send(OperationTypes.REQUEST_DB_EXIST, data)
			.then(function(results) {
				resolve(results);
			})
			.error(function(error) {
...
Server.prototype.list = function() {
	...
	return new Promise(function(resolve, reject) {
		self.send(OperationTypes.REQUEST_DB_LIST)
			.then(function(results) {
				results			= results || {};
				resolve(results);
			})
...
Server.prototype.configList = function() {
	...
	return new Promise(function(resolve, reject) {
		...
		self.send(OperationTypes.REQUEST_CONFIG_LIST)
			.then(function(results) {
				resolve(results);
			})
			.error(function(error) {
...
Server.prototype.configGet = function(key) {
	...
	return new Promise(function(resolve, reject) {
		...
		self.send(OperationTypes.REQUEST_CONFIG_GET, data)
			.then(function(results) {
				resolve(results);
			})
			.error(function(error) {
...
Server.prototype.configSet = function(key, value) {
	...
	return new Promise(function(resolve, reject) {
		...
		self.send(OperationTypes.REQUEST_CONFIG_SET, data)
			.then(function(results) {
				resolve(results);
			})
			.error(function(error) {
...
Server.prototype.freeze = function(databaseName) {
	...
	return new Promise(function(resolve, reject) {
		self.send(OperationTypes.REQUEST_DB_FREEZE, databaseName)
			.then(function(results){
				resolve(results);
			})
			.error(function(error) {
...
Server.prototype.release = function(databaseName) {
	...
	return new Promise(function(resolve, reject) {
		self.send(OperationTypes.REQUEST_DB_RELEASE, databaseName)
			.then(function(results){
				resolve(results);
			})
			.error(function(error) {
...
Server.prototype.shutdown = function() {
	...
	return new Promise(function(resolve, reject) {
		...
		self.send(OperationTypes.REQUEST_SHUTDOWN, data)
			.then(function(results){
				resolve(results);
			})
			.error(function(error) {
