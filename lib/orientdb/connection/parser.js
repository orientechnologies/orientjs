...
var deserializeORIDs = function(orid, accumulatedRIDs) {
    if (orid["@type"] !== "b") {
    ...
    offset += BYTES_INT + BYTES_BYTE + BYTES_SHORT + BYTES_LONG; //ignoring color and parent rid
    ...
    for (var i = 0; i < nodeSize; i++) {
        ...
        offset += BYTES_LONG;
        accumulatedRIDs.push(toRid(clusterId, clusterPosition));
    }
...
exports.deserializeORIDs = deserializeORIDs;
