...
var Server = exports.Server = function(options) {
    ...
    if (!parser.isNullOrUndefined(this.options.logger) && (parser.typeOfVar(this.options.logger.debug) === parser.TYPE_FUNCTION) && (parser.typeOfVar(this.options.logger.error) === parser.TYPE_FUNCTION)) {
