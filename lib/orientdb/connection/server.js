...
Server.prototype.configGet = function(configKey, callback) {
    ...
    this.send(OperationTypes.CONFIG_GET, configKey, function(err, configValue) {
        if (err) return callback(err);
...
Server.prototype.configSet = function(configKey, configValue, callback) {
    ...
    this.send(OperationTypes.CONFIG_SET, data, function(err) {
        callback(err);
    });
};
...
Server.prototype.freeze = function(databaseName, callback) {
    ...
    this.send(OperationTypes.DB_FREEZE, databaseName, callback);
};
...
Server.prototype.release = function(databaseName, callback) {
    ...
    this.send(OperationTypes.DB_RELEASE, databaseName, callback);
};
